...
export default async (generationConfig) => {
    ...
    // We read the existing config ONLY to preserve the 'exclusions' array.
    ...
    if (fs.existsSync(configPath)) {
        try {
            ...
            // Check for modern object format with exclusions
            if (!Array.isArray(existingConfig) && Array.isArray(existingConfig.exclusions)) {
