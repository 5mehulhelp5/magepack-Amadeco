    ...
    for (const localePath of localesPaths) {
        ...
        for (const bundle of bundlingConfig) {
            ...
            if (isMinifyOn || forceMinify) {
                ...
                const terserConfig = {
                    parse: {
                        ecmascript: 2020 // Parse modern syntax
                    },
                    compress: {
                        passes: 2,           // Run compression twice to catch cascading optimizations
                        drop_console: true,  // Remove console.log in production
                        drop_debugger: true, // Remove debugger statements
                        pure_getters: true,  // Optimize getter functions
                        keep_fargs: false,   // Drop unused function arguments
                        unsafe: true,        // Enable some safe-ish unsafe transformations
                    },
                    output: {
                        comments: false,
                        ecmascript: 5,       // Force ES5 output for maximum Magento compatibility
                    },
                    mangle: {
                        reserved: [
                            '$',
                            ...
                            'require',
                            'exports',
                            'jquery' // Add 'jquery' lower case just in case
                        ],
                    },
                };
