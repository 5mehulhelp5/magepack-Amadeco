...
export const composeMixinTarget = (targetId, targetContent, mixinSources) => {
    ...
    //
    // Without explicit semicolons, Terser's aggressive mode (or any minifier
    // that strips whitespace) can produce:
    //
    //   define("target",[...],function(){...})define("mixin",[...],function(){...})
    //
    // JavaScript interprets this as `define(...)( define(...) )` — calling
    // the return value of the first define() as a function, which throws
    // "define(...) is not a function".
    //
    // The trailing semicolon ensures each define() is an independent
    // ExpressionStatement regardless of whitespace removal.
    ...
    const parts = [
        ensureTrailingSemicolon(targetContent),
